...
-- main gruvbox color palette (only what's needed for DARK HARD)
---@class GruvboxPalette
Gruvbox.palette = {
    -- dark hard backgrounds
    dark0_hard = "#181818",
    dark1 = "#3c3836",
    dark2 = "#504945",
    dark3 = "#665c54",
    ...
    -- foreground steps (light ramp used as fg in dark mode)
    light0 = "#fbf1c7",
    light1 = "#ebdbb2",
    light2 = "#d5c4a1",
    light3 = "#bdae93",
    ...
    -- dark tints for diffs (hard variants)
...
-- Build the single (dark hard) color table.
local function get_colors()
    local p = Gruvbox.palette
    local config = Gruvbox.config

    -- allow user overrides (kept for flexibility)
    for color, hex in pairs(config.palette_overrides) do
        p[color] = hex
    end

    -- Single fixed scheme: DARK HARD
    local colors = {
        -- backgrounds (hard)
        bg0 = p.dark0_hard,
        bg1 = p.dark1,
...
local function get_groups()
    ...
    local groups = {
        ...
        GruvboxWhite = { fg = colors.fg0 }, -- provide this as it’s referenced later
